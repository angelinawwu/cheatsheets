...
export default function LeftSidebar({ cheatsheets, selectedIndex, onSelect }: LeftSidebarProps) {
  return (
    <div className="h-full w-[320px] bg-[#191919] border-r border-white/30 shadow-[0px_12px_20px_0px_rgba(0,5,151,0.05)] flex flex-col gap-3 px-3 py-6 overflow-hidden z-10">
